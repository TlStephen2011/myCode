...
void Team::setGoalsFor(int gf)
{
    goalsFor = gf;
}

void Team::setGoalsAgainst(int ga)
{
    goalsAgainst = ga;
}
...
bool operator>(const Team &Team1, const Team &Team2)
{
    ...
    else if (Team1 == Team2 && (Team1.goalsFor - Team1.goalsAgainst) > (Team2.goalsFor - Team2.goalsAgainst))
    {
        return true;
    }
    else
...
{
    ins >> Team1.country >> Team1.round >> Team1.points >> Team1.goalsFor >> Team1.goalsAgainst;
    return ins;
}