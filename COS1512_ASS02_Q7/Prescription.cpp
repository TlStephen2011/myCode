...
Prescription::Prescription(string med, string pName, string fund, int num,
                           double c) {
  medication = med;
  patientName = pName;
  medAidFund = fund;
...
// accessors
string Prescription::getMedication() { return medication; }

string Prescription::getPatientName() { return patientName; }

string Prescription::getMedAidFund() { return medAidFund; }

int Prescription::getMedAidNum() { return medAidNum; }

double Prescription::getMedCost() { return medCost; }
