...
int main()
{
	...
	cout << "Employee Name: " << firstEmployee.getFirstName() + " " + firstEmployee.getLastName() << endl;
	cout << "Salary : "
		 << "R" << firstEmployee.getSalary() << endl
		 << endl;
	cout << "Employee Name: " << secondEmployee.getFirstName() + " " + secondEmployee.getLastName() << endl;
	cout << "Salary: "
